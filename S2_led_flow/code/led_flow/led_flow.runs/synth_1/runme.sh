...
HD_PWD='D:/ProgramData/GitHub/Vivado_Project/S2_led_flow/code/led_flow/led_flow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_flow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_flow.tcl
